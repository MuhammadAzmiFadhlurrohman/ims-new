                            ...
                            <div style='display: flex; flex-direction: column; gap: 14px; font-size: 12.5px; line-height: 1.4;'>
                                ...
                                <div style='background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 12px 14px;'>
                                    ...
                                    <div style='display: flex; flex-wrap: wrap; gap: 8px;'>
                                        ...
                                        <button type='button' onclick=\"window.openImsTableAction('jadwal_survey', '{$key}')\" wire:click=\"mountTableAction('jadwal_survey', '{$key}')\" style='padding: 6px 12px; background: #e0f2fe; color: #0369a1; border: 1px solid #bae6fd; font-weight: 800; border-radius: 8px; font-size: 11.5px; cursor: pointer;'>📅 Jadwal Survey</button>
                                        <button type='button' onclick=\"window.openImsTableAction('report_survey', '{$key}')\" wire:click=\"mountTableAction('report_survey', '{$key}')\" style='padding: 6px 12px; background: #ccfbf1; color: #0f766e; border: 1px solid #99f6e4; font-weight: 800; border-radius: 8px; font-size: 11.5px; cursor: pointer;'>📋 Report Survey</button>
                                        <button type='button' onclick=\"window.openImsTableAction('jadwal_instalasi', '{$key}')\" wire:click=\"mountTableAction('jadwal_instalasi', '{$key}')\" style='padding: 6px 12px; background: #e0e7ff; color: #4338ca; border: 1px solid #c7d2fe; font-weight: 800; border-radius: 8px; font-size: 11.5px; cursor: pointer;'>🔧 Jadwal Instalasi</button>
                                        <button type='button' onclick=\"window.openImsTableAction('report_instalasi', '{$key}')\" wire:click=\"mountTableAction('report_instalasi', '{$key}')\" style='padding: 6px 12px; background: #dcfce7; color: #15803d; border: 1px solid #bbf7d0; font-weight: 800; border-radius: 8px; font-size: 11.5px; cursor: pointer;'>✅ Report Instalasi</button>
                                        <button type='button' onclick=\"window.openImsTableAction('posting_aktivasi', '{$key}')\" wire:click=\"mountTableAction('posting_aktivasi', '{$key}')\" style='padding: 6px 12px; background: #f3e8ff; color: #7e22ce; border: 1px solid #e9d5ff; font-weight: 800; border-radius: 8px; font-size: 11.5px; cursor: pointer;'>🚀 Posting Aktivasi</button>
                                        <button type='button' onclick=\"window.openImsTableAction('batal_pasang', '{$key}')\" wire:click=\"mountTableAction('batal_pasang', '{$key}')\" style='padding: 6px 12px; background: #ffe4e6; color: #be123c; border: 1px solid #fecdd3; font-weight: 800; border-radius: 8px; font-size: 11.5px; cursor: pointer;'>❌ Batal Pasang</button>
                                    </div>
                                </div>
                            </div>
                        ");
