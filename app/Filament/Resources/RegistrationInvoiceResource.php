            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('invoice_number')
                    ...
                    ->state(function (RegistrationInvoice $record): \Illuminate\Support\HtmlString {
                        ...
                        $statusLabel = $isPaid ? 'PAID' : 'DRAFT BILLING';
                        $statusPillClass = $isPaid ? 'ims-pill-active' : 'ims-pill-warning';
                        ...
                        $detailPayload = [
                            ...
                            'statustype' => (string) "Biaya: Rp {$amountFormatted}",
                            'sales' => (string) ($record->payment_method ?? 'Midtrans'),
                            ...
                            <div class='ims-standalone-card'>
                                ...
                                <div class='ims-card-status-section'>
                                    <div class='ims-schedule-pill {$statusPillClass}'>
                                        ...
                                        <span class='ims-schedule-slot'>🗓️ Terbit: {$createdStr}</span>
                                    </div>
                                </div>
                                <div class='ims-card-sep'></div>
                                <button
