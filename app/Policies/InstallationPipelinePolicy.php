...
class InstallationPipelinePolicy
{
     ...
     */
    public function view(User $user, InstallationPipeline $installationPipeline): bool
    {
     ...
     */
    public function update(User $user, InstallationPipeline $installationPipeline): bool
    {
     ...
     */
    public function delete(User $user, InstallationPipeline $installationPipeline): bool
    {
     ...
     */
    public function forceDelete(User $user, InstallationPipeline $installationPipeline): bool
    {
     ...
     */
    public function restore(User $user, InstallationPipeline $installationPipeline): bool
    {
     ...
     */
    public function replicate(User $user, InstallationPipeline $installationPipeline): bool
    {
