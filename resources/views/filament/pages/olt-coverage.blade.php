        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('oltCoverageApp', (allOdpsData, initialCoordinates) => ({
                ...
                initMap() {
                    ...
                    // CartoDB Dark Matter Tiles (Fits Admin theme perfectly)
                ...
                async executeCoverageCheck() {
                    ...
                    // Calculate distance to all ODPs
                    const odpList = this.allOdps.map(odp => {
                        ...
                        return {
                            ...
                            distance: dist,
                            isCovered: dist <= 150,
                            roadDistance: Math.round(dist * 1.25) // initial estimate
                        };
                    ...
                    if (odpList.length > 0) {
                        ...
                        // Animate connection line on map
                ...
                async drawConnectionToOdp(userLat, userLng, result) {
                    ...
                    // Remove previous user layer and line
                    ...
                    // Progressive Propagation Animation along road
                    let totalLength = 0;
