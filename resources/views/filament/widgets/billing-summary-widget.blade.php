...
<div class="ims-billing-summary-container" style="display: flex; flex-direction: row; align-items: stretch; gap: 12px; width: 100%; margin: 8px 0 14px 0; padding: 0 1.5rem; box-sizing: border-box;">
