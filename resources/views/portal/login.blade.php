...
<body class="flex flex-col justify-between min-h-screen text-slate-800 bg-[#F4FAFF] relative overflow-x-hidden">
    ...
    <header class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5 flex items-center justify-between relative z-10 shrink-0">
        ...
        <a href="{{ url('/') }}" class="flex items-center gap-2.5 group">
            <div class="w-9 h-9 rounded-xl bg-brand text-white flex items-center justify-center font-bold text-xs shadow-sm group-hover:scale-105 transition-transform">
    ...
    <main class="w-full flex-1 flex items-center justify-center px-4 py-6 relative z-10">
        ...
        <div class="bg-white border border-blue-100 rounded-3xl p-7 sm:p-9 max-w-[420px] w-full shadow-brand-soft relative overflow-hidden">
            ...
            <div class="text-center mb-6">
                <h1 class="font-heading text-2xl sm:text-3xl font-black text-brand-navy mb-2 tracking-tight">
                    Layanan Pelanggan
                </h1>
            ...
            <form action="{{ route('customer.login') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="flex items-center h-12 px-3.5 rounded-2xl bg-brand-pale border border-slate-200 focus-within:border-brand focus-within:bg-white focus-within:ring-2 focus-within:ring-brand/20 transition-all shadow-inner">
                ...
                <button type="submit" class="w-full h-12 rounded-2xl btn-brand-primary text-white font-black text-xs sm:text-sm shadow-md shadow-brand/20 transition-all flex items-center justify-center gap-2 hover:shadow-lg">
