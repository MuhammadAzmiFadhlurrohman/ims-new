...
<style>
    ...
    .ims-right-form .fi-input-wrp-suffix button[style*="display: none"],
    .ims-right-form .fi-input-wrp-suffix .fi-icon-btn[style*="display: none"],
    .ims-right-form .fi-input-wrp-suffix [style*="display: none"],
    .ims-right-form .fi-input-wrp-suffix button[hidden],
    .ims-right-form .fi-input-wrp-suffix .fi-icon-btn[hidden],
    .ims-right-form .fi-input-wrp-suffix [hidden],
    .ims-right-form .fi-input-wrp-suffix .hidden {
        display: none !important;
    }
